    ...
    <section>
        <div class="formHolder" id="searchBoxTop">
            ...
            <label><span>EMPRESA</span>
                        <asp:DropDownList ID="cbEmpresa" Width="200px" runat="server" ><asp:ListItem Text="Todas" Value="0" /></asp:DropDownList>
            </label>
        ...
        <asp:ListView ID="lvEmpresas" runat="server" 
            ...
            <ItemTemplate>                   
                <tr style="cursor:pointer;" onclick="Visible(<%# Eval("id")%> )" >
                    ...
                    <td><asp:Label ID="lbDominio" runat="Server" Text='<%#Eval("dominioMail") %>' /></td>
            ...
            <EditItemTemplate>
                <tr class="editRow">
                <td>
                  <asp:TextBox ID="txtEditId" runat="server" Text='<%#Bind("id") %>' Enabled="False" style="width:45px;" />
                </td>
                <td>
                ...
                <td>
                  <asp:TextBox ID="txtEditDominio" runat="server" MaxLength="25" Text='<%#Bind("dominioMail") %>' />
                </td>
                <td>
            ...
            <InsertItemTemplate>
                <tr class="editRow">
                    ...
                    <td>
                        ...
                        <asp:TextBox ID="txtDominio" runat="server" Text='<%#Bind("dominioMail") %>' />
                    </td>
