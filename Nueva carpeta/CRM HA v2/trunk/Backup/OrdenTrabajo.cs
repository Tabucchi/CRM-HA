...
namespace crm {
    ...
    public class OrdenTrabajo : ReportClass {
    ...
    public class CachedOrdenTrabajo : Component, ICachedReport {
        
        public CachedOrdenTrabajo() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            OrdenTrabajo rpt = new OrdenTrabajo();
            rpt.Site = this.Site;
            return rpt;
        }
