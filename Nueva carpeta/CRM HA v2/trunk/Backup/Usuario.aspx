...
<asp:ListView ID="lvUsuarios" runat="server" 
    ...
    <EditItemTemplate>
        <tr class="editRow">
        <td><asp:TextBox ID="txtEditId" runat="server" Text='<%#Bind("id") %>' Enabled="False" style="width:30px;" /></td>
        <td><asp:TextBox ID="txtEditNombre" runat="server" Text='<%#Bind("nombre") %>' /></td>
        ...
        <td>
            <asp:DropDownList ID="ddlEditCategoria" runat="server" SelectedValue='<%#Bind("idCategoria") %>'>
                    <asp:ListItem Value="3" Text="Soporte" />
                    <asp:ListItem Value="1" Text="Administración" />
                    <asp:ListItem Value="2" Text="Desarrollo" />
                    <asp:ListItem Value="4" Text="Telecomunicaciones" />
            </asp:DropDownList> 
        </td>
        <td>
    ...
    <InsertItemTemplate>
        <tr class="editRow">
            ...
            <td>
                <asp:DropDownList ID="ddlEditCategoria" runat="server">
                    <asp:ListItem Value="3" Text="Soporte" />
                    <asp:ListItem Value="1" Text="Administración" />
                    <asp:ListItem Value="2" Text="Desarrollo" />
                    <asp:ListItem Value="4" Text="Telecomunicaciones" />
...
<div class="rfloat" align="right" style="width:48%;">Paginas:       
    <asp:DataPager ID="_moviesGridDataPager" PageSize="20" runat="server" PagedControlID="lvUsuarios">
