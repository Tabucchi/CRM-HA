...
public class cDataBase : IDisposable
{
    ...
    public int InsertObject(string nombreTabla, List<cAtributo> atributos)
    {
        try
        {
            ...
            cmd.Dispose();
            Desconectar();
            return Convert.ToInt32(GetIdentity(nombreTabla));
        }
        catch
        {
            Dispose();
    ...
    // Update Generico
    public int UpdateObject(string id, string nombreTabla, List<cAtributo> atributos)
    {
        try
        {
            Conectar();
    ...
    public Hashtable LoadObject(string id, string nombreTabla)
    {
        try
        {
            Conectar();
    ...
    public byte[] ExecuteScalarByte(SqlCommand com)
    {
        try
        {
            Conectar();
            com.Connection = cnn;
            byte[] r = (byte[])com.ExecuteScalar();
            com.Dispose();
            Desconectar();
            return r;
        }
    ...
    public DataSet GetDataSet(SqlCommand cmd, string nombreTabla)
    {
        try
        {
            Conectar();
            ...
            da.Fill(ds, nombreTabla.ToString());
            da.Dispose();
    ...
    public DataTable GetDataReader(SqlCommand com)
    {
        try
        {
    ...
    public string ExecuteBackUp(string _database, string _url)
    {
        try
        {
            string query = "BACKUP DATABASE " + _database + " TO DISK = '" + _url + "'";
