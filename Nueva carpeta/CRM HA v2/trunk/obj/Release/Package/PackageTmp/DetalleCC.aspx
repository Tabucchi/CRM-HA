<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="DetalleCC.aspx.cs" Inherits="crm.DetalleCC" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        ...
        <asp:Panel ID="pnlPago" runat="server" Visible="false">
            <section>
                <asp:Panel ID="pnlRadioButtonList" runat="server" >
                <div runat="server" class="formHolderCalendar" style="padding: 12px 25px 30px;">
                    <div>
                        <modaltitle style="text-align:left">
                            Pago
                            <asp:LinkButton ID="btnCerrarPagos" runat="server" class="cancelBtn" CommandName="Cancel" Text="Cerrar" ToolTip="Cerrar" OnClick="btnCerrarPagos_Click"  />
                        </modaltitle></div>
            ...
            <section>
                <asp:Panel ID="pnlPagoCuota" runat="server" Visible="false">            
                    <div runat="server" class="formHolderCalendar" style="padding: 12px 25px 16px;">
                        <div>
                            <modaltitle style="text-align:left">Pago de cuota</modaltitle>
                        </div>
                        <hr style="margin-bottom: 10px;"/>
                        <div align="left" class="h7" style="float:right;width: 100%;margin-bottom: 10px;">Seleccione de la lista la cuota para realizar el pago</div>
                        <div runat="server">
                        ...
                        <asp:Panel ID="pnlBotonesPago" runat="server">
                            <div runat="server">
                                <div runat="server">
                                    <div>
                                        <label>
                    ...
                    <asp:Panel ID="PagoCuotaMonto" runat="server" Visible="false" style="margin-top: 24px;">
                        <div runat="server" class="formHolderCalendar" style="padding: 0px 25px 30px;">
                            <div class="headLine" style="height: 5px;"></div>
            ...
            <section>
                <asp:Panel ID="pnlOtrosPago" runat="server" Visible="false">
                    <div runat="server" class="formHolderCalendar" style="padding: 12px 25px 30px;">
                        <div><modaltitle style="text-align:left">Otros Pagos</modaltitle></div>
                        <hr style="margin-bottom: 10px;"/>
                        <div align="left" class="h7" style="float:right;width: 100%;margin-bottom: 10px;">Realice diferentes pagos, que no estén relacionados con el pago de cuotas</div>
                        
                        <div class="headLine" style="height: 35px;"></div>
                        <div style="margin-top: 20px;">
                            <div class="divFormInLine">
                                <div style="float:left">
                                    <label>
                    ...
                    <div runat="server" class="formHolderCalendar" style="padding: 12px 10px 10px;">
                        <div runat="server">
                            <div style="float:left; margin-top: 4px;">
                                ...
                                <label>
                                    <asp:Button ID="btnCancelarOtrosPago" Text="Cancelar" class="formBtnNarCancel" runat="server" style="margin-left: 10px;" OnClick="btnCancelarOtrosPago_Click"/>
                                </label>
                            </div>
                        </div>
                    </div>
            ...
            <section>
                <asp:Panel ID="pnlAdelantoCuota" runat="server" Visible="false">
                    <div runat="server" class="formHolder" style="padding: 12px 25px 30px;">
                        <div><modaltitle style="text-align:left">Adelanto de cuotas</modaltitle></div>
                        <hr style="margin-bottom: 10px;"/>
                        <div align="left" class="h7" style="float:right;width: 100%;margin-bottom: 10px;">De cada forma de pago se podrán efectuar adelantos, los cuales se realizan a partir de la última cuota</div>
                        <div class="headLine" style="height: 35px;"></div>
                    ...
                    <asp:Panel ID="pnlCantCuotas" runat="server" Visible="false">
                        <div runat="server" class="formHolder" style="padding: 12px 25px 30px;">
                            <div class="headLine" style="height: 2px;"></div>
                            <div style="margin-top: 20px;">
                                <div class="divFormInLine">
                                    <div>
                                        <label style="width: 250px;">
                                            Cantidad de cuotas para adelantar:
                        ...
                        <div runat="server" class="formHolderCalendar" style="padding: 12px 10px 10px;">
                            <div runat="server">
                                <div style="float:left; margin-top: 4px;">
                                    ...
                                    <label>
                                        <asp:Button ID="btnCancelarAdelantoCuota" Text="Cancelar" class="formBtnNarCancel" runat="server" style="margin-left: 10px;" OnClick="btnCancelarAdelantoCuota_Click"/>
                                    </label>
                                </div>
                            </div>
                        </div>
            ...
            <section>
                <asp:Panel ID="pnlCancelarSaldo" runat="server" Visible="false">
                    <div runat="server" class="formHolder" style="padding: 12px 25px 30px;">
                        <div><modaltitle style="text-align:left">Cancelación de saldo</modaltitle></div>
                        <hr style="margin-bottom: 10px;"/>
                        <div align="left" class="h7" style="float:right;width: 100%;margin-bottom: 10px;">En esta opción, puede cancelar el total de la deuda restante de la operación de venta</div>
                        <div class="headLine" style="height: 35px;"></div>
                        <div style="margin-top: 12px;">
                            <div class="divFormInLine">
                            <label>
                        ...
                        <div runat="server" class="formHolderCalendar" style="padding: 12px 10px 10px;">
                            <div runat="server">
                                <div style="float:left; margin-top: 4px;">
                                    ...
                                    <label>
                                        <asp:Button ID="btnCancelarCancelarSaldo" Text="Cancelar" class="formBtnNarCancel" runat="server" style="margin-left: 10px;" OnClick="btnCancelarCancelarSaldo_Click"/>
                                    </label> 
                                </div>
                            </div>
                        </div>
            ...
            <section>
                <asp:Panel ID="pnlAnular" runat="server" Visible="false">
                    <div runat="server" class="formHolder" style="padding: 12px 25px 12px;">
                        ...
                        <div style="margin-top: 12px;">
                            ...
                            <div>
                                ...
                                <label>
                                    <asp:Button ID="btnCancelarAnular" Text="Cancelar" class="formBtnNarCancel" runat="server" style="margin-left: 10px; margin-top: 15px;" OnClick="btnCancelarAnular_Click"/>
                                </label>
                            </div>
                        </div>
                        </div>
                    ...
                    <asp:Panel ID="pnlConceptoAnular" runat="server" Visible="false">
                        <div runat="server" class="formHolderCalendar" style="padding: 10px 25px 0px;">
                            <div class="headLine" style="height: 2px;"></div>
                            <div style="margin-top: 12px;">
                                <div class="divFormInLine">
                                <div style="float:left; width: 900px;">
                            ...
                            <div runat="server">
                                <div style="float:left; margin-top: 4px;">
                                    <label>
                                     ...
                                     <label>
                                        <asp:Button ID="btnCancelarAnularComprobante" Text="Cancelar" class="formBtnNarCancel" runat="server" style="margin-left: 10px;" OnClick="btnCancelarAnularComprobante_Click"/>
                                    </label>
                                </div>
                            </div>
                        </div>
            ...
            <section>
                <asp:Panel ID="pnlAnularReserva" runat="server" Visible="false">
                    ...
                    <div>
                        <div runat="server">
                            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                <ContentTemplate>
                                    <div runat="server" class="formHolder" style="padding: 12px 25px 0px;">
                                        <div class="h7" style="float:right;width: 100%; margin-bottom: 5px;">A continuación se listan las reservas</div>
                                    ...
                                    <div runat="server" class="formHolder" style="padding: 4px 10px 2px;">
                                        <div class="divFormInLine" style="margin-bottom: 18px;">
                                            <div>
                                                ...
                                                <label>
                                                    <asp:Button ID="btnCancelarReservas" Text="Cancelar" class="formBtnNarCancel" runat="server" style="margin-left: 10px; margin-top: 31px;" OnClick="btnCancelarReservas_Click"/>
                                                </label> 
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <asp:Panel ID="pnlConceptoAnularReserva" runat="server" Visible="false">
                        ...
                        <div runat="server" class="formHolderCalendar" style="padding-top: 36px; padding-bottom: 39px;">
                            <div class="headLine" style="height: 5px;"></div>
                            <div runat="server">
                                <div style="float:left;">
                                    Devolución de reserva
                                    <label>
                                        <asp:RadioButtonList ID="rblDevolucion" runat="server" RepeatDirection="Horizontal" TabIndex="7" OnTextChanged="rblDevolucion_TextChanged" AutoPostBack="true" style="box-shadow: inherit; margin-bottom: -20px !important;">
                    ...
                    <asp:Panel ID="pnlBotonesAnularReserva" runat="server" Visible="false">    
                        <div runat="server" class="formHolderCalendar" style="padding: 12px 10px 10px;">
                            <div class="headLine" style="height: 5px;"></div>
                            <div runat="server">
                                <div style="float:left; margin-top: 4px;">
                                    ...
                                    <label>
                                        <asp:Button ID="btnCancelarAnularReserva" Text="Cancelar" class="formBtnNarCancel" runat="server" style="margin-left: 10px;" OnClick="btnCancelarAnularReserva_Click"/>
                                    </label> 
                                </div>
                            </div>
                        </div>
            ...
            <section>
                <asp:Panel ID="pnlCondonacion" runat="server" Visible="false">            
                    <div runat="server" class="formHolderCalendar" style="padding: 12px 25px 16px;">
                        <div><modaltitle style="text-align:left">Condonación</modaltitle></div>
                        <hr style="margin-bottom: 10px;"/>
                        <div align="left" class="h7" style="float:right;width: 100%;margin-bottom: 10px;">Seleccione de la lista la cuota para realizar la condonación</div>
                        <div runat="server">
                        ...
                        <asp:Panel ID="pnlBotonesCondonacion" runat="server">
                            <div runat="server">
                                <div runat="server">
                                    <div>
                                        <label>
                    ...
                    <asp:Panel ID="CondonacionCuotaMonto" runat="server" Visible="false" style="margin-top: 24px;">
                        <div runat="server" class="formHolderCalendar" style="padding: 0px 25px 30px;">
                            <div class="headLine" style="height: 5px;"></div>
                            <div style="margin-top: 20px;">
                                <div class="divFormInLine" style="width: 200px !important;">
        ...
        <asp:Panel ID="pnlMensajeAnular" runat="server" Visible="false">
            <section>
                <div runat="server" class="formHolderAlert alert" style="padding: 14px 25px 12px; background-color: #dff0d8; border-color: #d6e9c6;">
                    <div>
                        <asp:Label ID="Label11" runat="server" CssClass="messageError" style="margin-left: 7px;">No se encontraron comprobantes.</asp:Label>
                    </div>
                </div>
            </section>
        </asp:Panel>
        ...
        <asp:Panel ID="pnlAdelanto" runat="server" Visible="false">
            <section>
                <div runat="server" class="formHolderAlert alert" style="padding: 14px 25px 12px; background-color: #dff0d8; border-color: #d6e9c6;">
                    <div>
                        <asp:Label ID="Label9" runat="server" class="messageError" style="margin-left: 7px;">No se pueden adelantar cuotas porque hay cuotas pendientes</asp:Label>
                    </div>
                </div>
            </section>
        </asp:Panel>
            ...
            <section>
                <div runat="server" class="formHolderCalendar" style="padding: 12px 25px 30px;">
                    <div>
                        <modaltitle style="text-align:left">
                            Nota de Crédito
                            <asp:LinkButton ID="btnCancelarNC" runat="server" class="cancelBtn" CommandName="Cancel" Text="Cerrar" ToolTip="Cerrar" OnClick="btnCancelarNC_Click"  />
                        </modaltitle>
                    </div>
                    <hr style="margin-bottom: 24px;"/>
            ...
            <section>
                <div runat="server" class="formHolderCalendar" style="padding: 12px 25px 30px;">
                    <div>
                        <modaltitle style="text-align:left">
                            Nota de Débito
                            <asp:LinkButton ID="btnCancelarND" runat="server" class="cancelBtn" CommandName="Cancel" Text="Cerrar" ToolTip="Cerrar" OnClick="btnCancelarND_Click"  />
                        </modaltitle>
                    </div>
                    <hr style="margin-bottom: 24px;"/>
                    <div class="divFormInLine">
