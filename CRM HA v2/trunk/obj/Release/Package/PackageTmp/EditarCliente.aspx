<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="EditarCliente.aspx.cs" Inherits="crm.EditarCliente" %>
                ...
                <ContentTemplate>
                    ...
                    <div class="formHolder"  style="padding: 22px 25px 12px;">
                        <div class="divFormInLine">
                            <label>
                                Condición de IVA: 
                                <asp:DropDownList ID="ddlCondicionIva" runat="server" CssClass="dropDownList dropDownListForm" TabIndex="5" style="width: 234px; margin-top:2px"></asp:DropDownList>
                    ...
                    <div class="formHolder"  style="padding: 22px 25px 12px;">
                        <div><modaltitle style="text-align:left; font-size: 16px !important;">Comentarios</modaltitle></div>
                        <hr class="line">
                        <div class="divFormInLine">
                            <label>
                                <asp:TextBox ID="txtComentario" runat="server" CssClass="textBox textBoxForm" TextMode="MultiLine" TabIndex="15" style="width: 900px; margin-top: 2px;"></asp:TextBox>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="formHolder"  style="padding: 22px 25px 12px;">
                        ...
                        <div class="divFormInLine">
                            <label style="width: 100%;">
                                ...
                                <asp:DropDownList ID="cbApoderado" runat="server" CssClass="dropDownList dropDownListForm" style="width: 234px; margin-top:2px" AutoPostBack="True" OnSelectedIndexChanged="ddlCondicion_SelectedIndexChanged">
                ...
                <ContentTemplate>
                    ...
                    <div class="formHolder"  style="padding: 22px 25px 12px;">
                        ...
                        <div class="divFormInLine">
                            <label>
                                Cuit: 
                                <asp:TextBox ID="txtCuitJuridica" runat="server" CssClass="textBox textBoxForm cuit" style="width: 220px; margin-top: 2px;"></asp:TextBox>
                            </label>
                        </div>                      
                    </div>
                    ...
                    <div class="formHolder"  style="padding: 22px 25px 12px;">
                        ...
                        <div class="divFormInLine">
                            <label>
                                Calle: 
                                <asp:TextBox ID="txtCalleJuridica" runat="server" CssClass="textBox textBoxForm" TabIndex="18" style="width: 220px; margin-top: 2px;"></asp:TextBox>
                            </label>
                        </div>
                        <div class="divFormInLine">
                            <label>
                                Dirección: 
                                <asp:TextBox ID="txtDireccionJuridica" runat="server" CssClass="textBox textBoxForm" TabIndex="19" style="width: 220px; margin-top: 2px;"></asp:TextBox>
                            </label>
                        </div>                       
                        <div class="divFormInLine">
                            <label>
                                Código Postal: 
                                <asp:TextBox ID="txtCodPostalJuridica" runat="server" CssClass="textBox textBoxForm" TabIndex="20" style="width: 220px; margin-top: 2px;"></asp:TextBox>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="formHolder"  style="padding: 22px 25px 12px;">
                        <div class="divFormInLine">
                            <label>
                                Provincia: 
                                <asp:DropDownList ID="cbProvinciaJuridica" runat="server" CssClass="dropDownList dropDownListForm" TabIndex="21" style="width: 234px; margin-top:2px">
                                    <asp:ListItem Value="1">Capital Federal</asp:ListItem>
                                    <asp:ListItem Value="2">Buenos Aires</asp:ListItem>
                                    <asp:ListItem Value="3">Catamarca</asp:ListItem>
                                    <asp:ListItem Value="4">Córdoba</asp:ListItem>
                        ...
                        <div class="divFormInLine">
                            <label>
                                Ciudad: 
                                <asp:TextBox ID="txtCiudadJuridica" runat="server" CssClass="textBox textBoxForm" TabIndex="22" style="width: 220px; margin-top: 2px;"></asp:TextBox>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="formHolder"  style="padding: 22px 25px 12px;">
                        ...
                        <div class="divFormInLine">
                            <label>
                                Teléfono: 
                                <asp:TextBox ID="txtTelefonoJuridica" runat="server" CssClass="textBox textBoxForm" TabIndex="23" style="width: 220px; margin-top: 2px;"></asp:TextBox>
                            </label>
                        </div>
                        <div class="divFormInLine">
                            <label>
                                Email: 
                                <asp:TextBox ID="txtMailJuridica" runat="server" CssClass="textBox textBoxForm" TabIndex="24" style="width: 220px; margin-top: 2px;"></asp:TextBox>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="formHolder"  style="padding: 22px 25px 12px;">
                        ...
                        <div class="divFormInLine">
                            <label>
                                <asp:TextBox ID="txtComentarioJuridica" runat="server" CssClass="textBox textBoxForm" TextMode="MultiLine" TabIndex="25" style="width: 900px; margin-top: 2px;"></asp:TextBox>
                            </label>
                        </div>
                    </div>
                    <div class="formHolder" style="padding: 8px 25px 12px;">
                        ...
                        <ContentTemplate>
                            <div class="formHolder"  style="padding: 22px 25px 12px;">
                                ...
                                <div class="divFormInLine">
                                    <div>
                                        <label>
                                            Nombre y Apellido:
                                            <asp:TextBox ID="txtNombreApoderadoJuridica" runat="server" CssClass="textBox textBoxForm" style="width: 220px; margin-top: 2px;"></asp:TextBox>
                                ...
                                <div class="divFormInLine">
                                    <label>
                                        Cuit: 
                                        <asp:TextBox ID="txtCuitApoderadoJuridica" runat="server" CssClass="textBox textBoxForm cuit" style="width: 220px; margin-top: 2px;"></asp:TextBox>
                            ...
                            <div class="formHolder"  style="padding: 22px 25px 12px;">
                                ...
                                <div class="divFormInLine">
                                    <div>
                                        <label>
                                            Tipo:
                                            <br />
                                            <asp:DropDownList ID="cbTipoDocApoderadoJuridica" runat="server" CssClass="dropDownList dropDownListForm" style="width: 234px; margin-top:2px">
                                                <asp:ListItem Value="1">DNI</asp:ListItem>
                                                <asp:ListItem Value="2">CI</asp:ListItem>
                                                <asp:ListItem Value="3">LC</asp:ListItem>
                                                <asp:ListItem Value="4">LE</asp:ListItem>
                                ...
                                <div class="divFormInLine">
                                    <div>
                                        <label>
                                            Número:
                                            <asp:TextBox ID="txtNroDocApoderadoJuridica" runat="server" CssClass="textBox textBoxForm" style="width: 220px; margin-top: 2px;"></asp:TextBox>
                                        </label>
                                    </div>
                                </div>
                            </div>
                            <div class="formHolder"  style="padding: 22px 25px 12px;">
                                ...
                                <div class="divFormInLine">
                                    <label>
                                        Calle: 
                                        <asp:TextBox ID="txtCalleApoderadoJuridica" runat="server" CssClass="textBox textBoxForm" style="width: 220px; margin-top: 2px;"></asp:TextBox>
                                    </label>
                                </div>
                                <div class="divFormInLine">
                                    <label>
                                        Dirección: 
                                        <asp:TextBox ID="txtDireccionApoderadoJuridica" runat="server" CssClass="textBox textBoxForm" style="width: 220px; margin-top: 2px;"></asp:TextBox>
                                    </label>
                                </div>
                                ...
                                <div class="divFormInLine">
                                    <label>
                                        Código Postal: 
                                        <asp:TextBox ID="txtCodPostalApoderadoJuridica" runat="server" CssClass="textBox textBoxForm" style="width: 220px; margin-top: 2px;"></asp:TextBox>
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="formHolder"  style="padding: 22px 25px 12px;">
                                <div class="divFormInLine">
                                    <label>
                                        Provincia: 
                                        <asp:DropDownList ID="cbProvinciaApoderadoJuridica" runat="server" CssClass="dropDownList dropDownListForm" style="width: 234px; margin-top:2px">
                                            <asp:ListItem Value="1">Capital Federal</asp:ListItem>
                                            <asp:ListItem Value="2">Buenos Aires</asp:ListItem>
                                            <asp:ListItem Value="3">Catamarca</asp:ListItem>
                                            <asp:ListItem Value="4">Córdoba</asp:ListItem>
                                ...
                                <div class="divFormInLine">
                                    <label>
                                        Ciudad: 
                                        <asp:TextBox ID="txtCiudadApoderadoJuridica" runat="server" CssClass="textBox textBoxForm" style="width: 220px; margin-top: 2px;"></asp:TextBox>
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="formHolder"  style="padding: 22px 25px 12px;">
                                ...
                                <div class="divFormInLine">
                                    <label>
                                        Teléfono: 
                                        <asp:TextBox ID="txtTelefonoApoderadoJuridica" runat="server" CssClass="textBox textBoxForm" style="width: 220px; margin-top: 2px;"></asp:TextBox>
                                    </label>
                                </div>
                                <div class="divFormInLine">
                                    <label>
                                        Email: 
                                        <asp:TextBox ID="txtMailApoderadoJuridica" runat="server" CssClass="textBox textBoxForm" style="width: 220px; margin-top: 2px;"></asp:TextBox>
                                    </label>
                                </div>
                            </div>
                        </ContentTemplate>
                        ...
                        <div runat="server" class="formHolder" style="padding: 22px 14px 12px;">
                            <div runat="server">
                                <div style="float:left">
                                    <label><asp:Button ID="btnGuardar" Text="Guardar" class="formBtnNar" runat="server" style="float:left; margin-top: -4px; margin-left: 15px;" Validationgroup="validateCliente" OnClick="btnGuardar_Click"/></label>
                                </div>
                                <div style="float:right">
                                    <asp:Button ID="btnVolver" Text="Volver a la agenda" class="formBtnGrey1" runat="server" style="float:left; margin-left:15px; margin-top: -5px;" OnClick="btnVolver_Click"/>
                                </div> 
                                <div style="float:right">
                                    <label><asp:Button ID="btnEliminar" Text="Eliminar" class="formBtnNar" runat="server" style="float:left; margin-top: -4px; margin-left: 15px;" Validationgroup="validateCliente" OnClick="btnEliminar_Click"/></label>
                                </div>                            
                            </div>
                        </div>
                    </ContentTemplate>
