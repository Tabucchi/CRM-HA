...
<div id="loginTop">
	<div id="loginContent">
		...
		<p>Accediendo a Naex CRM versión 5.0.0 contará con un complejo conjunto de herramientas eficaces para el control de sus empresa y su relación con sus abonados.</p>
		<ul id="crmOptions">
    ...
    <div id="loginForm">
    	...
    	<label class="checkLabel"><input type="checkbox" id="recordarUsuario" tabindex="3"/> Recordar mi usuario</label>
...
<div id="loginBottom"> 
	<div class="loginTweets">
		<img class="loginImg" src="images/login_18.png">
	</div>
	<div id="loginFooter">http://crm.naex.com.ar © 2013</div>
</div>
</form>
</body>
</html>