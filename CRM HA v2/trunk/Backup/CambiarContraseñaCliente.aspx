<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageCliente.master" AutoEventWireup="true" CodeBehind="CambiarContraseñaCliente.aspx.cs" Inherits="crm.CambiarContraseñaCliente" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section>
        ...
        <div class="formHolder">
            <p class="col3"><strong>Usuario:</strong> <asp:Literal ID="lbCliente" runat="server" ></asp:Literal></p> 
            <p class="col3">&nbsp;</p>
            <p class="col3">&nbsp;</p>
            <p><strong>Nueva Clave:</strong> <asp:TextBox ID="txtPassword" runat="server" 
                    TextMode="Password" style="width:200px" MaxLength="20"></asp:TextBox></p>
            <p><strong>Confirmar: </strong><asp:TextBox ID="txtConfirmarContraseña" 
                    runat="server" Width="200px" TextMode="Password" MaxLength="20"></asp:TextBox> </p>
