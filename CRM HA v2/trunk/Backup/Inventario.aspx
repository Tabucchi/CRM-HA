...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section>
        <div class="formHolder" id="searchBoxTop">
            ...
            <label style="width:20%; margin-left:0px">
                <span>EMPRESA</span>
                <asp:DropDownList ID="cbEmpresa" runat="server" AutoPostBack="True" 
                onselectedindexchanged="cbEmpresa_SelectedIndexChanged">
                    <asp:ListItem Value="1">Naex</asp:ListItem>
                    <asp:ListItem Value="2">Bethcom</asp:ListItem>
                    <asp:ListItem Value="3">HA</asp:ListItem>
                </asp:DropDownList>
            </label>  

            <label style="width:28%; margin-left:0px">
                <span>RESPONSABLE</span>
                <asp:DropDownList ID="cbResponsable" runat="server"></asp:DropDownList>
            </label>

            <label style="padding-bottom:0px; width: 26%; margin-left:-24px">
                <span >CATEGORIA</span>
                <asp:DropDownList ID="cbCategoria" runat="server" Width="38%"> <asp:ListItem Text="Mesa" 
                        Value="1" /></asp:DropDownList>
            </label>  

            <label align="left" style="width:20%; margin-left:58px;">
                <span>VALOR</span>
            ...
            <label style="margin-left:-26px; width: 44%;">
            ...
            <label style="width:36%; margin-left:40px; padding-left:18px">
            ...
            <label>
                <asp:Label ID="lbMensaje" runat="server" Visible="False" Font-Bold="True" 
    ...
    <section>
        <div class="formHolder" id="Div1">
            <div class="formHolderLine">
                <h2>Buscar:</h2>
            </div>
            <label>
                <span>EMPRESA</span>
                <asp:DropDownList ID="cbBuscarEmpresa" runat="server" AutoPostBack="True" onselectedindexchanged="cbBuscarEmpresa_SelectedIndexChanged">
                    <asp:ListItem Value="1">Naex</asp:ListItem>
                    <asp:ListItem Value="2">Bethcom</asp:ListItem>
                    <asp:ListItem Value="3">HA</asp:ListItem>
                </asp:DropDownList>
